# AGENTS.md — Phase 1B BRS Study Wiki Schema
...
- **Subject:** The Phase 1B Bioregulatory Systems (BRS) medicine course at Imperial College London.
...
- **Out of scope:** Material from other course phases or modules (e.g. CSI, LMAP, PCH), university administration, and medical detail unrelated to the Phase 1B BRS curriculum, unless it directly clarifies an in-scope topic. If a source is broader than the wiki's scope, extract only the in-scope facts; note out-of-scope content in the source page's "Out of scope notes" section but do not propagate it into entity/concept pages.
...
│   ├── pdfs/                         # lecture/handout PDFs, organised by topic:
...
├── site/                             # HTML study hub (home, topic/lecture pages, Anki decks)
...
The template was instantiated for the Phase 1B Bioregulatory Systems (BRS) medicine course at Imperial College London on 2026-07-16. The wiki is ready for its first ingest per §5.1.
